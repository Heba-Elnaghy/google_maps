...
import 'package:google_maps/models/location_info/lat_lng.dart';
import 'package:google_maps/models/location_info/location.dart';
import 'package:google_maps/models/location_info/location_info.dart';
...
import 'package:google_maps/utils/routes_service.dart';
...
class MapServices {
  ...
  Future<void> getPredictions(
      ...
      required List<PlaceAutocompletModel> places}) async {
    if (input.isNotEmpty) {
